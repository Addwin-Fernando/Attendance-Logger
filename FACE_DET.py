# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 00:44:31 2022
...
while True:
    ...
    for current_face_location,current_face_encoding in zip(all_face_locations,all_face_encodings):
        ...
        if True in all_matches:
            ...
            #if the a registered face is detected their name is appended to a new list 
            output.append(known_face_names[first_match_index])
            b=np.unique(output)
            
            
            #then using numpy and pandas the final output is saved as a excel sheet
            final_output=[b]
